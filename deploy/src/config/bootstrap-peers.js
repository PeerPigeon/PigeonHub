...
export const PRODUCTION_BOOTSTRAP_PEERS = [
  // Heroku deployment - Live production server
  { 
    t: 'wss', 
    u: 'wss://pigeonhub-server-3c044110c06f.herokuapp.com',
    region: 'us-east',
    priority: 1,
    description: 'Heroku US East - Primary bootstrap'
  },
  
  // Fly.io deployment - Live production server
  { 
    t: 'wss', 
    u: 'wss://pigeonhub.fly.dev',
    region: 'global',
    priority: 1,
    description: 'Fly.io Global - Primary bootstrap'
  },
  
  // Railway deployment (Backup) - Community maintained
  { 
    t: 'wss', 
  ...
  // Community fallback peers for additional resilience
  { 
    t: 'wss', 
